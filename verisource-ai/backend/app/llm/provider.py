...
2. If the provided evidence does not contain the answer, you MUST output exactly: INSUFFICIENT_EVIDENCE
3. The extracted evidence may be messy, incomplete, or lack context due to PDF parsing. You must synthesize the core rule clearly into a professional, formal response.
4. Use deterministic language: "must", "shall", "is required", "is prohibited".
5. Do NOT summarize or add external context. State only the rules found in the text.
6. Do NOT mention the evidence process, document IDs, scores, or internal system details."""
...
1. Use ONLY the evidence provided. Do NOT use outside knowledge.
2. If the provided evidence does not contain the answer, you MUST output exactly: INSUFFICIENT_EVIDENCE
3. The extracted evidence may be messy or incomplete. You must synthesize the core findings clearly into a professional, formal response.
4. Use probabilistic language: "suggests", "indicates", "may imply", "the evidence shows".
5. Do NOT present uncertain findings as facts.
6. Do NOT mention the evidence process, document IDs, scores, or internal system details."""
